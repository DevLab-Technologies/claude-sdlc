...
| `/sdlc-visualize [slug]` | Live Pipeline Floor for a feature — who is working on what, what is left, what each agent cost. Starts automatically with every pipeline run |
